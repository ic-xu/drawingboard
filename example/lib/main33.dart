...
//         child: Row(
//           children: <Widget>[
//             Container(height: 50,width: 100,color: Colors.tealAccent,),
...
//             Container(height: 50,width: 100,color: Colors.yellowAccent,),
//             Container(height: 50,width: 100,color: Colors.greenAccent,),
//             Container(height: 50,width: 100,color: Colors.grey,),
//             Container(height: 50,width: 100,color: Colors.blueAccent,),
//             Container(height: 50,width: 100,color: Colors.green,),
//             Container(height: 50,width: 100,color: Colors.tealAccent,),
//             Container(height: 50,width: 100,color: Colors.teal,),
//             Container(height: 50,width: 100,color: Colors.black,),
